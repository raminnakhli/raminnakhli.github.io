...
- **AMIGO! Sparse Multi-modal Graph Transformer with Shared-Context Processing for Representation Learning of Gigapixel Images** <span style="color:green;"> new! </span><br> **<u>R. E. Nakhli</u>**, P. Azadi, et al. <br> **CVPR**, 2023 <br> [paper](https://arxiv.org/abs/2303.00865){:target="_blank" rel="noopener"} / [code](https://github.com/raminnakhli/amigo){:target="_blank" rel="noopener"} <br> <br>
